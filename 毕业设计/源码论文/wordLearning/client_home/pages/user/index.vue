					...
					<mm_col>
						<mm_view class="">
							<view  class="list_module">
								<view v-if="user_group != '管理员' && $check_action('/registered_user/table','get')">
									<navigator class="my_module" url="/pages/registered_user/table" hover-class="hover">
										<div>
											<text>注册用户</text>
											<span>></span>
										</div>
								...
								<view v-if="user_group != '管理员' && $check_action('/word_classification/table','get')">
									<navigator class="my_module" url="/pages/word_classification/table" hover-class="hover">
										<div>
											<text>单词分类</text>
											<span>></span>
										</div>
								...
								<view v-if="user_group != '管理员' && $check_action('/encyclopedia_of_words/table','get')">
									<navigator class="my_module" url="/pages/encyclopedia_of_words/table" hover-class="hover">
										<div>
											<text>单词大全</text>
											<span>></span>
										</div>
